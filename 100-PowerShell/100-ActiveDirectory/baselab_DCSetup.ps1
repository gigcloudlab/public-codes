...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/gigcloudlab/public-codes/main/100-PowerShell/100-ActiveDirectory/baselab_LabStructure.ps1" -OutFile "C:\Baselab\baselab_NewUsers.ps1"
