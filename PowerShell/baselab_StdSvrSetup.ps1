...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/gigcloudlab/public-codes/main/PowerShell/baselab_DomainSetup.ps1" -OutFile "C:\BaselabS\baselab_StdSvrJoinDomain.ps1"
